...
| 10. Sparse/Mesh/Quant | Partial | Sparse build/matvec/solver-with-explicit-fallback/mmwrite plus canonical COO/CSR import/export helpers, mesh relation/attribute traversal, quantized kernel params, quant-float placement, and fixed quant saturation golden cases are covered. | Mesh reorder/index conversion and quant fixed-offset placement require deeper/native metadata support and remain skipped on current backends. |
