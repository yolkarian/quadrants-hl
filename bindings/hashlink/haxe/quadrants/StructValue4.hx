...
class StructValue4<T0, T1, T2, T3> {
  public final member0:StructMember<T0>;
  public final member1:StructMember<T1>;
  public final member2:StructMember<T2>;
  public final member3:StructMember<T3>;
  public var value0:T0;
  public var value1:T1;
  public var value2:T2;
  public var value3:T3;

  public function new(member0:StructMember<T0>, value0:T0, member1:StructMember<T1>, value1:T1, member2:StructMember<T2>, value2:T2, member3:StructMember<T3>, value3:T3) {
  ...
  public inline function field3():T3 {
    return value3;
  }
}
