...
HL_PRIM qd_context *HL_NAME(context_create_configured)(int arch, int enable_profiler, int num_compile_threads, int64 cuda_stack_limit, double device_memory_fraction);
