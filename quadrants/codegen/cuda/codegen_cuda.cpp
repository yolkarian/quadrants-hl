...
#undef UNARY_STD
  ...
  void create_offload_mesh_for(OffloadedStmt *stmt) override {
    ...
    llvm::Function *body;
    {
      ...
      llvm::Value *thread_idx = builder->CreateIntrinsic(Intrinsic::nvvm_read_ptx_sreg_tid_x,
                                                          ArrayRef<llvm::Type *>{}, ArrayRef<llvm::Value *>{});
 ...
 private:
  ...
  std::tuple<llvm::Value *, llvm::Value *> get_spmd_info() override {
    auto thread_idx = builder->CreateIntrinsic(Intrinsic::nvvm_read_ptx_sreg_tid_x, ArrayRef<llvm::Type *>{},
                                               ArrayRef<llvm::Value *>{});
    auto block_dim = builder->CreateIntrinsic(Intrinsic::nvvm_read_ptx_sreg_ntid_x, ArrayRef<llvm::Type *>{},
                                              ArrayRef<llvm::Value *>{});
